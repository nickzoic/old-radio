#!/usr/bin/env python
# $Id: symbols.py,v 1.7 2009-11-26 07:52:32 nick Exp $
import random
import re
import sys
...
def printheader(symbols, reserved, nsymbols):
    ...
    print
    print "/* using %d out of %d symbols */" % (len(symbols), nsymbols)
    print
...
if len(sys.argv) > 1:
    ...
    printheader(symbols, reserved, nsymbols)
else:
